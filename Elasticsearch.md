...
The distribution.virk.dk endpoint _/cvr-permanent/virksomhed/search_ requires authentification. 
Generate a basic authorization token by navigating to Authorization and entering username and password. 
